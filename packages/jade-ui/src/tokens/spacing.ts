/**
 * JADE Design System - Spacing Tokens
 *
 * Consistent spacing scale for the JADE ecosystem.
 * Based on 4px base unit with a t-shirt sizing system.
 */

export const spacing = {
  // Base scale (px values)
  0: '0',
  px: '1px',
  0.5: '0.125rem',  // 2px
  1: '0.25rem',     // 4px

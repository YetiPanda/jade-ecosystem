...
// Note: Icons are imported from the consuming application
// These are placeholder SVG components
...
const ChevronUpIcon = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"

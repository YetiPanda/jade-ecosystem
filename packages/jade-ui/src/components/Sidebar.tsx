...
// Inline PanelLeftIcon to avoid lucide-react dependency
const PanelLeftIcon = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
...
export interface SidebarInsetProps extends React.ComponentPropsWithoutRef<"main"> {}
...
export interface SidebarInputProps extends React.ComponentPropsWithoutRef<typeof Input> {}
...
export interface SidebarSeparatorProps extends React.ComponentPropsWithoutRef<typeof Separator> {}
...
export interface SidebarGroupContentProps extends React.ComponentPropsWithoutRef<"div"> {}
...
export interface SidebarMenuBadgeProps extends React.ComponentPropsWithoutRef<"div"> {}
...
export interface SidebarMenuSubProps extends React.ComponentPropsWithoutRef<"ul"> {}
...
export interface SidebarMenuSubItemProps extends React.ComponentPropsWithoutRef<"li"> {}
